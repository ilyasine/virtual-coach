                        ...
                        callbacks: {
                            open: function () {
                                ...
                                const breakpoints = [
                                    ...
                                    /* {          
                                        time: 20.14,
                                        text: `Perhaps put your hand on your chest or your belly as you breath.
                                                It can help us notice the air going in and out.
                                                Once you have noticed your breath tap the Next Clear Picture Do button.`,
                                        step: 'notice-my-breath.webp'
                                        }, */
                                    ...
                                    { time: 32.14, //Notice my surrounding
                                        ...
                                        step: 'notice-my-surroundings.webp'
                                    },
                                    ...
                                    { time: 58.16,
                                        ...
                                        step: 'label-and-rate-emotions.webp'
                                    },
                                  ...
                                  /*   {
                                        ...
                                        level_handle : true,
                                        text: `At a level 4 
                                                it is best not to use Calm Only skills like Problem Solving,
                                                Expressing Myself, Getting It Right, or Relationship Care.
                                                There is time for those when you are at 0-3 feelings.
                                                The Help tab has a list of people, phone numbers, and places you can call for support.
                                                Be sure to reach out to your coaches if you need help.`, 
                                        link: 'https://skillsystem.test/dashboard/?section=my-people',
                                        button: 'Go to My Stuff',
                                        step: 'notice-my-breath.webp'
                                    }, */
                                    /* { time: 228.24, // need help
                                        text: `If you would like to continue our check-In,
                                                tap the Continue Check-In button below.`, 
                                        link: 'https://skillsystem.test/dashboard/?section=get-help',
                                        button: 'Go to the Help Tab',
                                        step: 'notice-my-breath.webp'
                                    },
                                    { time: 233.6,
                                        text: ``, 
                                        finalbreakpoint: true,
                                        button: 'Continue Check-In',
                                        color: '#b1d234',
                                        step: 'notice-my-breath.webp'
                                    }, */

                                    // level 4 breakpoints end
                                    ...
                                    /* {
                                        time: 263.26,
                                        level_handle : true,
                                        text: `If you are not harming yourself, others, or property right now, you may be at a level 4.
                                        Tab the Back to Level 4 button for ways to manage Level 4 feelings. `, 
                                        button: 'My Safety Plans',
                                        link: 'https://skillsystem.test/dashboard/?section=my-safety-plan',
                                        color: 'red',
                                        step: 'notice-my-breath'
                                    },
                                    { time: 273.3, // need help
                                        text: ``, 
                                        backbreakpoint: true,
                                        button: 'Back to Level 4',
                                        step: 'notice-my-breath',
                                        finalbreakpoint: true,
                                    }, */
                                    /* (0-3 Feelings Ratings) */
                                    //Notice My tough : 
                                    {
                                        time: 100,
                                        //level_handle : true,
                                    ...
                                    //Notice My On-Track Thinking : 
                                    {
                                        ...
                                        options: [
                                            ...
                                            { id: 'not-helpful', value: 'not-helpful', label: 'Helpful' },                                          
                                        ],
                                        grid_class: 'space-center'
                                    },
                                ...
                                function displayOptions(breakpoint) {
                                    ...
                                    if (breakpoint.step) {
                                        $('#vc-step-img').attr('src', virtual_coach_data.img + breakpoint.step);
                                    }
                                    ...
                                    if (breakpoint.options) {
                                        ...
                                        $('.option-item').on('click', function () {
                                            ...
                                            if (target === '4-level') {
                                                ...
                                                isSeeking = true;
                                                moveToBreakpoint(100, video, breakpoints);
                                            }
                                        });
                                    } else {
