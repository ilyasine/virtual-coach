(function ($) {
    const VirtualCoachMyOnTrackActionPlan = {
        init: function () {
            ...
            //$('.add-new-otap-popup-content').tabs();

            $(document).on("click", "#add-new-otap-btn", function (e) {
                e.preventDefault();
                var $this = $(this);
                // Open the popup
                $.magnificPopup.open({
                        ...
                        open: function () {
                           ...
                           // Add click event handlers for Next and Previous buttons
                            $(".vc-foot-forward").click(function() {
                                var tabs = $(".add-new-otap-popup-content").tabs();
            ...
            //$('.edit-new-otap-popup-content').tabs();

            $(document).on("click", "#edit-otap-btn", function (e) {
                e.preventDefault();
                var $this = $(this);
                // Open the popup
                $.magnificPopup.open({
                    ...
                    callbacks: {
                        open: function () {
                            ...
                            $(".edit-otap-popup-content").tabs();
                            
                            // Add click event handlers for Next and Previous buttons
                            $(".vc-foot-forward").click(function() {
                                var tabs = $(".edit-otap-popup-content").tabs();
                                var active = tabs.tabs("option", "active");
                                tabs.tabs("option", "active", active + 1);
                            });
            ...
            //$('.delete-new-otap-popup-content').tabs();

            $(document).on("click", "#delete-otap-btn", function (e) {
                e.preventDefault();
                var $this = $(this);
                // Open the popup
                $.magnificPopup.open({
            ...
            $('#addnewotaprecordingsubmit').on('click', function () {
                if (mediaRecorder && mediaRecorder.state !== "inactive") {
                    mediaRecorder.stop();
                }
    ...
    window.VirtualCoachMyOnTrackActionPlan = VirtualCoachMyOnTrackActionPlan;
})(jQuery);
